...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/console/playground': { section: 'chat', module: 'playground' },
  '/dashboard': { section: 'console', module: 'detail' },
  '/dashboard/overview': { section: 'console', module: 'detail' },
  '/dashboard/models': { section: 'console', module: 'detail' },
  '/dashboard/users': { section: 'console', module: 'detail' },
  '/console/dashboard': { section: 'console', module: 'detail' },
  '/console/dashboard/overview': { section: 'console', module: 'detail' },
  '/console/dashboard/models': { section: 'console', module: 'detail' },
  '/console/dashboard/users': { section: 'console', module: 'detail' },
  '/console/models': { section: 'console', module: 'detail' },
  '/keys': { section: 'console', module: 'token' },
  '/console/keys': { section: 'console', module: 'token' },
  '/usage-logs': { section: 'console', module: 'log' },
  '/usage-logs/common': { section: 'console', module: 'log' },
  '/usage-logs/drawing': { section: 'console', module: 'midjourney' },
  '/usage-logs/task': { section: 'console', module: 'task' },
  '/console/usage-logs': { section: 'console', module: 'log' },
  '/console/usage-logs/common': { section: 'console', module: 'log' },
  '/console/usage-logs/drawing': { section: 'console', module: 'midjourney' },
  '/console/usage-logs/task': { section: 'console', module: 'task' },
  '/wallet': { section: 'personal', module: 'topup' },
  '/console/wallet': { section: 'personal', module: 'topup' },
  '/profile': { section: 'personal', module: 'personal' },
  '/console/profile': { section: 'personal', module: 'personal' },
  '/channels': { section: 'admin', module: 'channel' },
  '/admin/channels': { section: 'admin', module: 'channel' },
  '/models': { section: 'admin', module: 'models' },
  '/models/metadata': { section: 'admin', module: 'models' },
  '/models/deployments': { section: 'admin', module: 'models' },
  '/admin/models': { section: 'admin', module: 'models' },
  '/admin/models/metadata': { section: 'admin', module: 'models' },
  '/admin/models/deployments': { section: 'admin', module: 'models' },
  '/users': { section: 'admin', module: 'user' },
  '/admin/users': { section: 'admin', module: 'user' },
  '/redemption-codes': { section: 'admin', module: 'redemption' },
  '/admin/redemption-codes': { section: 'admin', module: 'redemption' },
  '/subscriptions': { section: 'admin', module: 'subscription' },
  '/admin/subscriptions': { section: 'admin', module: 'subscription' },
  '/system-settings': { section: 'admin', module: 'setting' },
  '/system-settings/site': { section: 'admin', module: 'setting' },
  '/admin/system-settings': { section: 'admin', module: 'setting' },
  '/admin/system-settings/site': { section: 'admin', module: 'setting' },
}
